...
"Every trade on Polymarket flows through here in real time.
...
## [CASE DETAIL — SCREEN RECORDING]

"The diamond is the trade. The dot is when the news broke. Six hours apart. That gap is the entire case.
...
## [SENTINEL INDEX — SCREEN RECORDING]

"That case gets published here. Permanently. The wallet addresses, the timeline, the full reasoning chain — all of it, in the open. That's the part that makes people uncomfortable.

Under each case there's an Arena. Community vote. The AI's reasoning is shown in full — you can read the evidence, disagree with the verdict, and say so publicly. This isn't 'trust the model.' It's 'here's everything the model found. Now you decide.'"

---

## [CLOSE — CAMERA]

"Compliance teams saw those wallets. Regulators saw them. Nobody published what they found.

Sentinel is open source. Fork it, run your own instance, submit a case. The code, the model, the index — all public.

Prediction market surveillance has always existed. We just made it open."
